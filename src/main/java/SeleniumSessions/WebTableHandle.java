...
public class WebTableHandle {
		...
		{
			return driver.findElement(By.xpath("//a[contains(text(),'"+name+"')]/parent::td/following-sibling::td/span")).getText();
		}
		public static List<String> getScoreCardList(String name)
		{
			List<String> scoreVal=new ArrayList<String>();
			List<WebElement> scoreList=driver.findElements(By.xpath("//a[contains(text(),'Yasir Ali')]/parent::td/following-sibling::td"));
